...
class GeminiDescriptionInference:
    ...
    def __call__(self, desc):
        prompt = (
            ...
            "Where [few_model] is True is ONLY if several unique detail numbers are listed (if it is absolutely clear from the description that several different physical details are sold), otherwise False. "
